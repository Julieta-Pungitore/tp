...
''' Encapsulamiento: cuando lo ejecutas dice "attribute error" pero esta bien, porq significa que no muestra ese metodo, es privado'''

''' Flores hereda los atributos, y le suma decoracion. 
El metodo para calcular el precio, sale 50% mas si decora con flores. '''

''' CONSUMIENDO API DE 3EROS '''
...
#     body = request.json #objeto request json que esta en el body. obtenemos un dicc que contiene el body. para acceder al valor del campo nombre del json, lo accedemos a traves del body y la clave de busqueda
...
''' AUTOMATIZACIÓN: indice de inflacion '''
# import sys
# argv = sys.argv
